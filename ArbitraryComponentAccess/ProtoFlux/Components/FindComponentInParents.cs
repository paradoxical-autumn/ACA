...
public class FindComponentInParentsLogix : ObjectFunctionNode<FrooxEngineContext, Component>
{
    ...
    protected override Component Compute(FrooxEngineContext context)
    {
        ...
        return ctxslot.GetComponentInParents<Component>( (c) => c.GetType() == ctxType && indx-- <= 0, ctxself );
    }
}