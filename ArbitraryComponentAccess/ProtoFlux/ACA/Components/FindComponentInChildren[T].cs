...
public class FindComponentInChildrenLogix<T> : ObjectFunctionNode<FrooxEngineContext, T> where T : Component
{
    ...
    protected override T Compute(FrooxEngineContext context)
    {
        ...
        return ctxslot.GetComponentInChildren<T>( (c) => indx-- <= 0, ctxself );
    }
}